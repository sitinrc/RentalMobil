...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card mt-4 shadow" style="background-color: #f8f9fa;">
                <div class="card-body">
                    <center>
                        <h3 class="text-primary">Jelajahi Koleksi Mobil Kami</h3>
                    ...
                    <div class="row">
                        @foreach (['fortuner', 'avanza', 'pajero', 'rush', 'suzuki', 'raize', 'hilux', 'yaris', 'xenia'] as $car)
                            <div class="col-md-4">
                    ...
                    <p class="text-dark bg-light p-3">Ingin mengetahui lebih lanjut atau memesan mobil hari ini? Hubungi tim kami di <strong>[nomor telepon]</strong> atau kirimkan email ke <strong>[alamat email]</strong>. Kami siap membantu Anda dengan senang hati!</p>
                </div>
            </div>
        </div>
    </div>
